<?php
/**
 * File for RcoreNwmlsImageWsdlClass to communicate with SOAP service
 ...
 */
/**
 * RcoreNwmlsImageWsdlClass to communicate with SOAP service
 *
 * @package RcoreNwmlsImage
 * @author RapidMod.com
 * @author 813.330.0522
 ...
 * @date 2017-01-04
 */
class RcoreNwmlsImageWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'http://images.idx.nwmls.com/imageservice/imagequery.asmx?WSDL';
    /**
    ...
    /**
     * Constructor
     * @uses RcoreNwmlsImageWsdlClass::setLastError()
     * @uses RcoreNwmlsImageWsdlClass::initSoapClient()
     * @uses RcoreNwmlsImageWsdlClass::initInternArrayToIterate()
     * @uses RcoreNwmlsImageWsdlClass::_set()
     ...
     * @return RcoreNwmlsImageWsdlClass
     */
     ...
     * @return RcoreNwmlsImageWsdlClass|null
     */
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'RcoreNwmlsImageWsdlClass'))
            {
     ...
     * @uses RcoreNwmlsImageClassMap::classMap()
     * @uses RcoreNwmlsImageWsdlClass::getDefaultWsdlOptions()
     * @uses RcoreNwmlsImageWsdlClass::getSoapClientClassName()
     * @uses RcoreNwmlsImageWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('RcoreNwmlsImageClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = RcoreNwmlsImageClassMap::classMap();
     ...
     * If a class is named as {RcoreNwmlsImage}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('RcoreNwmlsImageSoapClient') && is_subclass_of('RcoreNwmlsImageSoapClient','SoapClient'))
            return 'RcoreNwmlsImageSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses RcoreNwmlsImageWsdlClass::WSDL_CACHE_WSDL
     * @uses RcoreNwmlsImageWsdlClass::WSDL_COMPRESSION
     * @uses RcoreNwmlsImageWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses RcoreNwmlsImageWsdlClass::WSDL_ENCODING
     * @uses RcoreNwmlsImageWsdlClass::WSDL_EXCEPTIONS
     * @uses RcoreNwmlsImageWsdlClass::WSDL_FEATURES
     * @uses RcoreNwmlsImageWsdlClass::WSDL_LOGIN
     * @uses RcoreNwmlsImageWsdlClass::WSDL_PASSWORD
     * @uses RcoreNwmlsImageWsdlClass::WSDL_SOAP_VERSION
     * @uses RcoreNwmlsImageWsdlClass::WSDL_STREAM_CONTEXT
     * @uses RcoreNwmlsImageWsdlClass::WSDL_TRACE
     * @uses RcoreNwmlsImageWsdlClass::WSDL_TYPEMAP
     * @uses RcoreNwmlsImageWsdlClass::WSDL_URL
     * @uses RcoreNwmlsImageWsdlClass::VALUE_WSDL_URL
     * @uses RcoreNwmlsImageWsdlClass::WSDL_USER_AGENT
     * @uses RcoreNwmlsImageWsdlClass::WSDL_PROXY_HOST
     * @uses RcoreNwmlsImageWsdlClass::WSDL_PROXY_PORT
     * @uses RcoreNwmlsImageWsdlClass::WSDL_PROXY_LOGIN
     * @uses RcoreNwmlsImageWsdlClass::WSDL_PROXY_PASSWORD
     * @uses RcoreNwmlsImageWsdlClass::WSDL_LOCAL_CERT
     * @uses RcoreNwmlsImageWsdlClass::WSDL_PASSPHRASE
     * @uses RcoreNwmlsImageWsdlClass::WSDL_AUTHENTICATION
     * @uses RcoreNwmlsImageWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses RcoreNwmlsImageWsdlClass::getSoapClient()
     * @uses RcoreNwmlsImageWsdlClass::getFormatedXml()
     ...
     * @uses RcoreNwmlsImageWsdlClass::getSoapClient()
     * @uses RcoreNwmlsImageWsdlClass::convertStringHeadersToArray()
     ...
     * @uses RcoreNwmlsImageWsdlClass::count()
     * @return int
     */
     ...
     * @uses RcoreNwmlsImageWsdlClass::getInternArrayToIterate()
     * @uses RcoreNwmlsImageWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses RcoreNwmlsImageWsdlClass::offsetGet()
     * @return mixed
     */
     ...
     * @uses RcoreNwmlsImageWsdlClass::getInternArrayToIterateOffset()
     * @uses RcoreNwmlsImageWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses RcoreNwmlsImageWsdlClass::getInternArrayToIterateOffset()
     * @uses RcoreNwmlsImageWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @see RcoreNwmlsImageWsdlClass::offsetGet()
     * @uses RcoreNwmlsImageWsdlClass::offsetGet()
     * @param int $_index
     * @return mixed
     */
     ...
     * @uses RcoreNwmlsImageWsdlClass::getAttributeName()
     * @uses RcoreNwmlsImageWsdlClass::__toString()
     * @uses RcoreNwmlsImageWsdlClass::_set()
     * @uses RcoreNwmlsImageWsdlClass::_get()
     * @uses RcoreNwmlsImageWsdlClass::setInternArrayToIterate()
     * @uses RcoreNwmlsImageWsdlClass::setInternArrayToIterateIsArray()
     * @uses RcoreNwmlsImageWsdlClass::setInternArrayToIterateOffset()
     ...
     * @uses RcoreNwmlsImageWsdlClass::item()
     * @return mixed
     */
     ...
     * @uses RcoreNwmlsImageWsdlClass::item()
     * @uses RcoreNwmlsImageWsdlClass::length()
     * @return mixed
     */
